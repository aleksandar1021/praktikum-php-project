<?php 
    ...
    include("models/functionsAdmin.php");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="?page=admin&adminPage=logs" class="nav-item nav-link">Log file</a>
                    <a href="?page=admin&adminPage=statistics" class="nav-item nav-link">Statistics</a>
